...
Sha.addCommand({pattern: 'git', fromMe: whb, dontAddCommandList: true}, (async (message, match) => {
...
var afnplk = '```⏱ Time :' + plk_say + '```\n\n ```📅 Date :' + plk_here + '```'
	const buttons = [
        ...
        {buttonId: 'id1', buttonText: {displayText: '𝗚𝗜𝗧 \n\n\n ┏╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┓ \n      ☆ ~ɪᴛsᴍᴇ sʜᴀʜᴍᴡᴏʟ~ ☆ \n ┗╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┛ \n ┏╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┓ \n ┣☛ \n ┣☛ *ᴅᴇᴠᴇʟᴏᴘᴇʀ* : ʀᴀᴍsʜᴀᴅ sʜᴀ \n ┣☛ \n ┣☛ *ɴᴜᴍʙᴇʀ* : wa.me/917736951082 \n ┣☛ \n ┣☛ *ʙᴏᴛ ɢʀᴏᴜᴘ* https://chat.whatsapp.com/F7p4E5x9972EcD9w6pAPYg \n ┣☛ \n ┣☛ *ɪɴsᴛᴀ* :https://instagram.com/___ram_shad___kaz \n ┣☛ \n ┣☛ *ʏᴛ* :https://youtube.com/princerudh \n ┣☛ \n ┣☛ *ʙᴏᴛ ᴠɪᴅᴇᴏ* :https://youtu.be/zUGBjETc7PA \n ┣☛ \n ┣☛ *ɢɪᴛ* :https://github.com/ramshad-sha/Shahmwol \n ┣☛ \n ┣☛ *ɢɪᴛ* : https://github.com/Ottapettavan/SHAH-MWOL  \n ┣☛ \n ┣☛     ▎▍▌▌▉▏▎▌▉▐▏▌▎\n ┣☛     ▎▍▌▌▉▏▎▌▉▐▏▌▎ \n ┣☛         ₢ʀᴀᴍsʜᴀᴅ sʜᴀ \n ┣☛ \n ┗╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┛ \n ☛☛☛☛☛☛☛☛☛☛☛☛☛☛☛☛☛ \n ┏╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┓ \n ┣☛        ◩ *sʜᴀʜᴍᴡᴏʟ* ◪ \n ┗╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┛'}, type: 1},
